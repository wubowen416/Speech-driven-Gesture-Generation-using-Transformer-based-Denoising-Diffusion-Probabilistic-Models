...
Copied from: https://github.com/openai/glide-text2im/blob/main/glide_text2im/respace.py.
"""
...
def space_timesteps(num_timesteps, section_counts):
    ...
    if isinstance(section_counts, str):
        if section_counts.startswith("path:"):
            steps = np.load(section_counts.replace("path:", ""))
            return set(steps)
...
class GaussianSpacedDiffusion(GaussianDiffusion):
    """
